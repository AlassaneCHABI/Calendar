...
require_once plugin_dir_path(__FILE__) . 'includes/models/NotificationModel.php'; 
...
require_once plugin_dir_path(__FILE__) . 'includes/controllers/NotificationController.php';  
